...
formRef.addEventListener("submit", (evt)=>{
    ...
    if (localStorage.getItem("studentsList")) arrStudents = JSON.parse(localStorage.getItem("studentsList"));
    arrStudents.push(student);
    localStorage.setItem("studentsList", JSON.stringify(arrStudents));
    const currentIdx = arrStudents.length;
    tableRef.insertAdjacentHTML("beforeend", `<td>${currentIdx}. ${student.name}</td>
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (localStorageData) localStorageData.forEach((student, idx)=>{
...
// !edit student
const editStudentDataOpenBtnRef = document.querySelector("[data-button=editStudent]");
const editStudentBackdropRef = document.querySelector(".backdrop-edit");
const editStudentFormFormRef = document.querySelector("[data-form=editStudent]");
const editStudentDataCloseBtnRef = document.querySelector("[data-button=closeEditStudent]");
const numInputEditStudentRef = document.querySelector("[data-input=numEditInput]");
editStudentDataOpenBtnRef.addEventListener("click", ()=>editStudentBackdropRef.classList.toggle("is-hidden-edit"));
editStudentDataCloseBtnRef.addEventListener("click", ()=>editStudentBackdropRef.classList.toggle("is-hidden-edit"));
numInputEditStudentRef.addEventListener("input", (evt)=>{
    ...
    if (inputValue > 0 && inputValue <= localStorageData.length && localStorageData) {
        ...
        formElements.editVisitedCourse.value = localStorageData[inputValue - 1].visitedCourse;
...
editStudentFormFormRef.addEventListener("submit", (evt)=>{
    ...
    if (inputValue > 0 && inputValue <= localStorageData.length && localStorageData) {
        ...
        localStorageData[inputValue - 1].visitedCourse = formElements.editVisitedCourse.value;
...
// !delete student
const deleteStudentDataOpenBtnRef = document.querySelector("[data-button=deleteStudent]");
const deleteStudentBackdropRef = document.querySelector(".backdrop-delete");
const deleteStudentFormFormRef = document.querySelector("[data-form=deleteStudent]");
const deleteStudentDataCloseBtnRef = document.querySelector("[data-button=closeDeleteStudent]");
const numInputDeleteStudentRef = document.querySelector("[data-input=numDeleteInput]");
deleteStudentDataOpenBtnRef.addEventListener("click", ()=>deleteStudentBackdropRef.classList.toggle("is-hidden-delete"));
deleteStudentDataCloseBtnRef.addEventListener("click", ()=>deleteStudentBackdropRef.classList.toggle("is-hidden-delete"));
...
},{}]},["gRY1p","ebWYT"], "ebWYT", "parcelRequired126")
